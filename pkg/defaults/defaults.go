...
func New(catsrcDefinitions map[string]olm.CatalogSource, config map[string]bool) Defaults {
...
// default config
func GetGlobals() (map[string]olm.CatalogSource, map[string]bool) {
...
func GetGlobalDefinitions() map[string]olm.CatalogSource {
...
func populateDefsConfig(dir string) (map[string]olm.CatalogSource, map[string]bool, error) {
