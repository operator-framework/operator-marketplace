...
type PhaseReconcilerFactory interface {
	GetPhaseReconciler(log *logrus.Entry, csc *v1.CatalogSourceConfig) (Reconciler, error)
}
...
func (f *phaseReconcilerFactory) GetPhaseReconciler(log *logrus.Entry, csc *v1.CatalogSourceConfig) (Reconciler, error) {
