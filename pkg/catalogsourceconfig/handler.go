...
type Handler interface {
	Handle(ctx context.Context, catalogSourceConfig *v1.CatalogSourceConfig) error
}
...
func (h *catalogsourceconfighandler) Handle(ctx context.Context, in *v1.CatalogSourceConfig) error {
...
func getLoggerWithCatalogSourceConfigTypeFields(csc *v1.CatalogSourceConfig) *logrus.Entry {
