...
func (t *triggerer) Trigger(notification datastore.PackageUpdateNotification) error {
	...
	cscs := &v1.CatalogSourceConfigList{}
...
func (t *triggerer) setPackages(instance *v1.CatalogSourceConfig, notification datastore.PackageUpdateNotification) (packages string, updateNeeded bool) {
...
func (t *triggerer) update(instance *v1.CatalogSourceConfig, packages string) error {
