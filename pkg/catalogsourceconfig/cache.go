...
type cache struct {
	entries map[types.UID]*v1.CatalogSourceConfigSpec
}
...
type Cache interface {
	...
	Get(csc *v1.CatalogSourceConfig) (*v1.CatalogSourceConfigSpec, bool)
	...
	IsEntryStale(csc *v1.CatalogSourceConfig) (pkgStale bool, targetStale bool)

	// Evict removes the entry for the CatalogSourceConfig object from the cache.
	Evict(csc *v1.CatalogSourceConfig)

	// Set adds the CatalogSourceConfigSpec for the CatalogSourceConfig object
	// into the cache.
	Set(csc *v1.CatalogSourceConfig)
}

func (c *cache) Get(csc *v1.CatalogSourceConfig) (*v1.CatalogSourceConfigSpec, bool) {
	entry, found := c.entries[csc.ObjectMeta.UID]
	if !found {
		return &v1.CatalogSourceConfigSpec{}, false
	}
	return entry, true
}

func (c *cache) IsEntryStale(csc *v1.CatalogSourceConfig) (bool, bool) {
...
func (c *cache) Evict(csc *v1.CatalogSourceConfig) {
...
func (c *cache) Set(csc *v1.CatalogSourceConfig) {
	c.entries[csc.ObjectMeta.UID] = &v1.CatalogSourceConfigSpec{
...
func NewCache() Cache {
	return &cache{
		entries: make(map[types.UID]*v1.CatalogSourceConfigSpec),
	}
}
