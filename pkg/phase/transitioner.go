...
type Transitioner interface {
	TransitionInto(currentPhase *v1.ObjectPhase, nextPhase *v1.Phase) (changed bool)
}
...
func (t *transitioner) TransitionInto(currentPhase *v1.ObjectPhase, nextPhase *v1.Phase) (changed bool) {
...
func hasPhaseChanged(currentPhase *v1.ObjectPhase, nextPhase *v1.Phase) bool {
