...
// Add creates a new CatalogSourceConfig Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
// and Start it when the Manager is Started.
// USER ACTION REQUIRED: update cmd/manager/main.go to call this marketplace.Add(mgr) to install this Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileCatalogSourceConfig{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to CatalogSourceConfig
	...
	// Uncomment watch a Deployment created by CatalogSourceConfig - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &marketplacev1alpha1.CatalogSourceConfig{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=marketplace.redhat.com,resources=catalogsourceconfigs,verbs=get;list;watch;create;update;patch;delete
