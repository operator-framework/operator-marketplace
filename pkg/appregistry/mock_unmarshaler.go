...
// Source: ./pkg/appregistry/unmarshaler.go
...
import (
	...
	datastore "github.com/operator-framework/operator-marketplace/pkg/datastore"
	reflect "reflect"
)
...
func (m *MockblobUnmarshaler) Unmarshal(in []byte) (*datastore.Manifest, error) {
	ret := m.ctrl.Call(m, "Unmarshal", in)
	ret0, _ := ret[0].(*datastore.Manifest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
